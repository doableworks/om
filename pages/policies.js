...
export default function PoliciesPage() {
	return (
		<div>
			<MetaTags
				Title={"Policies | Om"}
				Desc={"Terms and Conditions and Privacy Policy for House of Om."}
				OgImg={""}
				Url={"/policies"}
			/>
			<Header />
			<main className={styles.PoliciesPage}>
				<div className={styles.policies_container}>
					...
					<p>Welcome to www.omdhumatkar.com!</p>
					<p>
						These terms and conditions outline the rules and regulations for the use
						of House of Om&apos;s Website, located at http://www.omdhumatkar.com/.
					</p>
					<p>
						By accessing this website we assume you accept these terms and conditions.
						Do not continue to use www.omdhumatkar.com if you do not agree to take all
					...
					<h2>Cookies</h2>
					<p>
						We employ the use of cookies. By accessing www.omdhumatkar.com, you agreed
						to use cookies in agreement with the House of Om&apos;s Privacy Policy.
					</p>
					<p>
					...
					<h2>License</h2>
					<p>
						Unless otherwise stated, House of Om and/or its licensors own the
						intellectual property rights for all material on www.omdhumatkar.com. All
						intellectual property rights are reserved. You may access this from
						www.omdhumatkar.com for your own personal use subjected to restrictions
						set in these terms and conditions.
					</p>
					<p>You must not:</p>
					<ul>
						<li>Republish material from www.omdhumatkar.com</li>
						<li>Sell, rent or sub-license material from www.omdhumatkar.com</li>
						<li>Reproduce, duplicate or copy material from www.omdhumatkar.com</li>
						<li>Redistribute content from www.omdhumatkar.com</li>
					</ul>
					<p>
					...
					<p>
						...
						opinions and information in certain areas of the website. House of Om does
						not filter, edit, publish or review Comments prior to their presence on
						the website. Comments do not reflect the views and opinions of House of
						Om, its agents and/or affiliates. Comments reflect the views and opinions
						of the person who post their views and opinions. To the extent permitted
						by applicable laws, House of Om shall not be liable for the Comments or
					...
					<p>
						House of Om reserves the right to monitor all Comments and to remove any
					...
					<p>
						You hereby grant House of Om a non-exclusive license to use, reproduce,
					...
					<p>
						...
						hyperlink compensates the absence of House of Om; and (d) the link is in
					...
					<p>
						...
						e-mail to House of Om. Please include your name, your organization name,
					...
					<p>
						No use of House of Om&apos;s logo or other artwork will be allowed for linking
