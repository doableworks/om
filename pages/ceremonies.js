		...
		<div>
			...
			<main className={`${styles.weddings_Page}`}>
				<section className={styles.banner} data-scroll>
					<video
						src="https://d299alzxgdp6.cloudfront.net/Copy+of+Top+Banner+-+Ceremonies.mp4"
					...
					/>
					<video
						src="https://d299alzxgdp6.cloudfront.net/Top+Banner+-+Ceremonies+Mobile.mp4"
				...
				<section className="container">
					...
					>
						...
						{isVideoPlaying && (
							<video
								src={
									"https://d299alzxgdp6.cloudfront.net/8151ace7-df7f-44aa-9c52-72304f1abe06.mp4"
								}
								className="img-responsive"
